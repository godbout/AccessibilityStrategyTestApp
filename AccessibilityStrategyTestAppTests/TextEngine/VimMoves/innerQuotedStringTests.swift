...
extension innerQuotedStringTests {
    ...
    func test_that_if_there_is_no_quote_then_it_returns_nil() {
        ...
        XCTAssertNil(
            textEngine.innerQuotedString(using: "\"", startingAt: 2, in: TextEngineLine(from: text))
        )
    }
    ...
    func test_that_if_there_is_only_one_quote_then_it_returns_nil_also() {
        ...
        XCTAssertNil(
            textEngine.innerQuotedString(using: "'", startingAt: 7, in: TextEngineLine(from: text))
        )
    }
    ...
    func test_that_if_there_are_two_quotes_and_the_caret_is_before_them_then_it_can_find_the_text() {
        ...
        guard let quotedStringRange = textEngine.innerQuotedString(using: "'", startingAt: 4, in: TextEngineLine(from: text)) else { return XCTFail() }
    ...
    func test_that_if_there_are_two_quotes_and_the_caret_is_between_them_then_it_can_find_the_text() {
        let text = "wow now we're gonna eat shit a bit' lol"
            ...
            guard let quotedStringRange = textEngine.innerQuotedString(using: "'", startingAt: 15, in: TextEngineLine(from: text)) else { return XCTFail() }
    ...
    func test_that_if_there_are_two_quotes_and_the_caret_is_after_them_then_it_returns_nil() {
        ...
        XCTAssertNil(
            textEngine.innerQuotedString(using: "`", startingAt: 18, in: TextEngineLine(from: text))
        )
    }
    ...
    func test_that_if_there_are_three_quotes_it_finds_the_correct_text() {
        ...
        guard let quotedStringRange = textEngine.innerQuotedString(using: "\"", startingAt: 29, in: TextEngineLine(from: text)) else { return XCTFail() }
...
"""
            ...
            guard let quotedStringRange = textEngine.innerQuotedString(using: "\"", startingAt: 41, in: TextEngineLine(from: text)) else { return XCTFail() }
...
"""
        XCTAssertNil(
            textEngine.innerQuotedString(using: "\"", startingAt: 41, in: TextEngineLine(from: text))
        )
    }
    ...
    func test_that_if_the_string_is_empty_it_returns_nil() {
        ...
        XCTAssertNil(
            textEngine.innerQuotedString(using: "\"", startingAt: 0, in: TextEngineLine(from: text))
        )
    }
...
"""
        guard let quotedStringRange = textEngine.innerQuotedString(using: "\"", startingAt: 9, in: TextEngineLine(from: text)) else { return XCTFail() }
