...
class nextTests: TextEngineBaseTests {}
...
extension nextTests {
    ...
    func test_that_in_normal_setting_it_returns_the_correct_location() {
        ...
        let location = textEngine.next("i", after: 10, in: TextEngineLine(from: text))
    ...
    func test_that_if_we_already_are_on_the_character_we_are_looking_then_we_get_the_location_of_the_next_occurrence() {
        ...
        let location = textEngine.next("f", after: 9, in: TextEngineLine(from: text))
...
"""
        let location = textEngine.next("z", after: 24, in: TextEngineText(from: text))
    ...
    func test_that_if_we_are_at_the_end_of_the_line_we_get_nil() {
        ...
        let location = textEngine.next("r", after: 24, in: TextEngineLine(from: text))
    ...
    func test_that_if_we_are_at_the_endLimit_of_the_line_we_get_nil_even_if_the_last_character_is_the_one_we_are_looking_for() {
        ...
        let location = textEngine.next("e", after: 28, in: TextEngineLine(from: text))
    ...
    func test_that_it_returns_nil_for_an_empty_line() {
        ...
        let location = textEngine.next("a", after: 0, in: TextEngineLine(from: text))
...
ask my opinion
"""
        let location = textEngine.next("k", after: 15, in: TextEngineText(from: text))
...
extension nextTests {
    ...
    func test_that_it_handles_emojis() {
        ...
        let location = textEngine.next("d", after: 2, in: TextEngineLine(from: text))
