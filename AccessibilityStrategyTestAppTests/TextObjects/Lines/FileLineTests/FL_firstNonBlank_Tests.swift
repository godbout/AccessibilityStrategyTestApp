...
extension FL_firstNonBlank_Tests {
    ...
    func test_that_if_the_line_starts_with_spaces_it_returns_the_correct_location() {
        ...
        let fileLine = FileLine(fullFileText: text, fullFileTextLength: text.utf16.count, caretLocation: 23)
    ...
    func test_that_if_the_line_starts_with_a_tab_character_it_still_returns_the_correct_location() {
        ...
        let fileLine = FileLine(fullFileText: text, fullFileTextLength: text.utf16.count, caretLocation: 17)
    ...
    func test_that_if_the_line_starts_with_a_fucking_mix_of_tabs_and_spaces_it_still_returns_the_correct_location() {
        ...
        let fileLine = FileLine(fullFileText: text, fullFileTextLength: text.utf16.count, caretLocation: 11)
    ...
    func test_that_if_the_line_starts_with_non_blank_characters_then_the_caret_location_is_0() {
        ...
        let fileLine = FileLine(fullFileText: text, fullFileTextLength: text.utf16.count, caretLocation: 30)
    ...
    func test_that_if_the_TextField_only_contains_spaces_it_returns_nil() {
        ...
        let fileLine = FileLine(fullFileText: text, fullFileTextLength: text.utf16.count, caretLocation: 5)
...
"""
        ...
        let fileLine = FileLine(fullFileText: text, fullFileTextLength: text.utf16.count, caretLocation: 7)
...
extension FL_firstNonBlank_Tests {
    ...
    func test_that_it_handles_emojis() {
        ...
        let fileLine = FileLine(fullFileText: text, fullFileTextLength: text.utf16.count, caretLocation: 1)
