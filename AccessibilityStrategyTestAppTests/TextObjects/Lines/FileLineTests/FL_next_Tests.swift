...
extension FL_next_Tests {
    ...
    func test_that_if_we_already_are_on_the_character_we_are_looking_then_we_get_the_location_of_the_next_occurrence() {
        ...
        let fileLine = FileLine(fullFileText: text, fullFileTextLength: text.utf16.count, caretLocation: 9)
...
"""
        ...
        let fileLine = FileLine(fullFileText: text, fullFileTextLength: text.utf16.count, caretLocation: 24)
    ...
    func test_that_if_we_are_at_the_endLimit_of_the_line_we_get_nil_even_if_the_last_character_is_the_one_we_are_looking_for() {
        ...
        let fileLine = FileLine(fullFileText: text, fullFileTextLength: text.utf16.count, caretLocation: 28)
...
"""
        let fileLine = FileLine(fullFileText: text, fullFileTextLength: text.utf16.count, caretLocation: 4)        
...
extension FL_next_Tests {
    ...
    func test_that_it_handles_emojis() {
        ...
        let fileLine = FileLine(fullFileText: text, fullFileTextLength: text.utf16.count, caretLocation: 2)
