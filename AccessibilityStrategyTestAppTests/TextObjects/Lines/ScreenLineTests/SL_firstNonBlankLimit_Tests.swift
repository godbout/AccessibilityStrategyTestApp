...
extension SL_firstNonBlankLimit_Tests {
    ...
    func test_that_if_the_line_starts_with_spaces_it_returns_the_correct_location() throws {
        ...
        let screenLine = try XCTUnwrap(
            ScreenLine(fullTextValue: text, fullTextLength: text.utf16.count, number: 1, start: 0, end: 25)
        )
    ...
    func test_that_if_the_line_starts_with_a_tab_character_it_still_returns_the_correct_location() throws {
        ...
        let screenLine = try XCTUnwrap(
            ScreenLine(fullTextValue: text, fullTextLength: text.utf16.count, number: 4, start: 32, end: 45)
        )
    ...
    func test_that_if_the_line_starts_with_a_fucking_mix_of_tabs_and_spaces_it_still_returns_the_correct_location() throws {
        ...
        let screenLine = try XCTUnwrap(
            ScreenLine(fullTextValue: text, fullTextLength: text.utf16.count, number: 1, start: 0, end: 30)
        )
    ...
    func test_that_if_the_line_starts_with_non_blank_characters_then_the_caret_location_is_0() throws {
        ...
        let screenLine = try XCTUnwrap(
            ScreenLine(fullTextValue: text, fullTextLength: text.utf16.count, number: 3, start: 15, end: 22)
        )
    ...
    func test_that_if_the_line_is_empty_it_returns_0() throws {
        ...
        let screenLine = try XCTUnwrap(
            ScreenLine(fullTextValue: text, fullTextLength: text.utf16.count, number: 1, start: 0, end: 0)
        )
    ...
    func test_that_if_the_line_only_contains_it_returns_nil() throws {
        ...
        let screenLine = try XCTUnwrap(
            ScreenLine(fullTextValue: text, fullTextLength: text.utf16.count, number: 1, start: 0, end: 8)
        )
    ...
    func test_that_if_the_line_only_contains_spaces_and_ends_with_a_linefeed_it_returns_nil() throws {
        ...
        let screenLine = try XCTUnwrap(
            ScreenLine(fullTextValue: text, fullTextLength: text.utf16.count, number: 1, start: 0, end: 6)
        )
...
extension SL_firstNonBlankLimit_Tests {
    ...
    func test_that_it_handles_emojis() throws {
        ...
        let screenLine = try XCTUnwrap(
            ScreenLine(fullTextValue: text, fullTextLength: text.utf16.count, number: 2, start: 16, end: 30)
        )
