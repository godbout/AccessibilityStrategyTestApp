...
extension FT_aSentence_OnBlankLines_Tests {
    ...
    func test_that_if_the_caret_is_on_the_first_BlankLine_of_the_text_then_it_returns_from_the_beginning_of_the_text_to_the_end_of_the_first_sentence_with_characters_not_including_the_trailing_newline() {
        let text = """
...
"""
    ...
    func test_that_if_the_text_ends_with_an_EmptyLine_below_a_group_of_BlankLines_and_that_before_them_there_is_also_an_EmptyLine_then_it_returns_from_the_beginning_of_the_EmptyLine_to_the_first_Blank_of_the_next_line_included() {
        let text = """
this is a line.
then one more.
and another one  
