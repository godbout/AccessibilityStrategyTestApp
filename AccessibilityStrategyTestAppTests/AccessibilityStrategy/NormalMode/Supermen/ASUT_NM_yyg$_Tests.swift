...
class ASUT_NM_yyg$_Tests: ASUT_NM_BaseTests {
    
    private func applyMoveBeingTested(on element: AccessibilityTextElement, _ vimEngineState: inout VimEngineState) -> AccessibilityTextElement {
        // see ccg$ for blah blah
        return asNormalMode.yygDollarSign(using: element.currentFileLine, on: element, &vimEngineState)
    }
