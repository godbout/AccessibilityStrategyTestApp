...
// actually in kV _ and $ are the same in VM. this is because we can't do like Vim
// that has a caret ON TOP of the selection. for macOS, the whole line selection is all we get.
class ASUT_VML_$_Tests: ASUT_VM_BaseTests {
