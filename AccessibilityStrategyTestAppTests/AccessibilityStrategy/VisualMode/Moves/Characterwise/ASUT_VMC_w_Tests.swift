...
class ASUT_VMC_w_Tests: ASVM_BaseTests {
    ...
    private func applyMove(on element: AccessibilityTextElement?) -> AccessibilityTextElement? {
        return asVisualMode.wForVisualStyleCharacterwise(on: element)
    }
...
// Both
extension ASUT_VMC_w_Tests {
    
    func test_that_if_the_head_is_after_the_anchor_it_extends_the_selected_length_to_the_beginning_of_the_word_forward() {
