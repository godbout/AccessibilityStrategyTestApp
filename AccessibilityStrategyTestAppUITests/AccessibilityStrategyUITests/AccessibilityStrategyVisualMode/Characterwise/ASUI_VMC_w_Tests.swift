...
class UIASVMC_w_Tests: ASUI_VM_BaseTests {
    
    private func applyMoveBeingTested() -> AccessibilityTextElement? {
        return applyMove { asVisualMode.wForVisualStyleCharacterwise(on: $0)}
    }

}


extension UIASVMC_w_Tests {
    
    func test_that_when_we_reach_the_anchor_and_will_reverse_anchor_and_head_the_w_move_does_not_block_and_moves_properly() {
