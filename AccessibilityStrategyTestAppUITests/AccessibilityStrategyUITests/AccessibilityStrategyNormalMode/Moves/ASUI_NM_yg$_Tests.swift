...
extension ASUI_NM_yg$_Tests {
    ...
    func test_that_if_the_ScreenLine_does_not_end_with_a_Newline_it_copies_from_the_caretLocation_to_the_LineEndLimit_included_and_does_not_Bip_and_sets_the_LastYankStyle_to_Characterwise() {
    ...
    func test_that_if_the_ScreenLineLine_ends_with_a_Newline_it_copies_from_the_caretLocation_to_the_LineEndLimit_included_and_does_not_Bip_and_sets_the_LastYankStyle_to_Characterwise() {
