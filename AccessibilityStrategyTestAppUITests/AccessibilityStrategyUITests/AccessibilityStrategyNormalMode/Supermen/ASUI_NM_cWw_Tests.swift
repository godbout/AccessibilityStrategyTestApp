...
extension ASUI_NM_cWw_Tests {
    ...
    func test_that_if_the_caret_is_on_a_NonBlank_when_it_is_called_in_PGR_Mode_it_does_delete_or_paste_in_UI_Elements_receptive_to_PGR() {
    ...
    func test_that_if_the_caret_is_on_a_NonBlank_when_it_is_called_in_PGR_Mode_it_does_delete_or_paste_and_once_only_in_UI_Elements_NOT_receptive_to_PGR() {
        let textInAXFocusedElement = "😂️😂️😂️😂️hehehe gonna use cw on this sentence"
