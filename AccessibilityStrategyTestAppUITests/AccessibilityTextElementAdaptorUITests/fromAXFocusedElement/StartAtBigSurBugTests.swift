...
"""
        ...
        XCTAssertEqual(accessibilityElement?.fullyVisibleArea, 0..<17)
        XCTAssertEqual(accessibilityElement?.currentScreenLine.value, "shit")
...
"""
        ...
        XCTAssertEqual(accessibilityElement?.selectedLength, 1)
        XCTAssertEqual(accessibilityElement?.fullyVisibleArea, 0..<17)
        XCTAssertEqual(accessibilityElement?.currentScreenLine.value, "some fucking\n")
...
"""
        ...
        XCTAssertEqual(accessibilityElement?.fullyVisibleArea, 0..<25)
        XCTAssertEqual(accessibilityElement?.currentScreenLine.value, "🕕️")
